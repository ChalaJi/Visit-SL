		...
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form action="delete" method="post"
					...
					<span class="contact2-form-title"> Delete Package </span>
					...
					<div class="wrap-input2 validate-input">
						<span class="label-input100">Destinations</span> <input
							...
							value="<%=pdestinations%>" readonly> <span
							class="focus-input2"></span>
					</div>
					...
					<div class="container-contact2-form-btn">
						<div class="wrap-contact2-form-btn">
							...
							<button class="contact2-form-btn">Delete Package</button>
						</div>
					</div>
				</form>
			</div>
